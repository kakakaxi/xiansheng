...
public class CreateQRcode {
	public static void main(String[] args) throws IOException {
		...
		BufferedImage logo=ImageIO.read(new File("D:/DOUYIN.jpg"));
		int douyinSize=imageSize/4;
		int o=(imageSize-douyinSize)/2;
		gs.drawImage(logo, o, o, douyinSize, douyinSize,null);
		gs.dispose();
		bufferedImage.flush();
		try{
